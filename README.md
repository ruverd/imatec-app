...
`imatec-app` is a large complex Single-Page Applications based on the newest development stack of [Vue.js](https://github.com/vuejs/vue) and use the UI Toolkit -- [element](https://github.com/ElemeFE/element). The project, built-in i18n solution and lots of awesome features. 
